...
//   const sortedStops = [...filteredStops].sort(
...
//               Found {sortedStops.length} result
//               {sortedStops.length !== 1 ? "s" : ""}
//             </div>
//           )}
...
//                                   style={{
//                                     backgroundColor: getArrivalColor(time),
//                                   }}
//                                 >
...
export default function LiveTracker() {
  ...
  const initializeMap = () => {
    ...
    busStops.forEach((stop) => {
      ...
      const infoWindow = new window.google.maps.InfoWindow({
        content: `<div style="font-weight:600;color:#1a1a1a;padding:4px 8px;">${stop.name}</div>`,
      });
