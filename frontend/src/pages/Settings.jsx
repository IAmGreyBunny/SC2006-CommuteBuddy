  ...
  return (
    <div className="settings-container">
      ...
      <section className="settings-section">
        <h3>Notifications</h3>
        <div className="settings-item">
          <span><HiMiniBellAlert /> Trip Reminders</span>
          <label className="switch">
            <input
              type="checkbox"
              checked={tripReminders}
        ...
        <div className="settings-item">
          <span><HiMiniBellAlert /> Live Arrival Alerts</span>
          <label className="switch">
            <input
              type="checkbox"
              checked={liveArrivalAlerts}
        ...
        <div className="settings-item">
          <span><TbClockPlus />Service Disruptions or Delays</span>
          <label className="switch">
            <input
              type="checkbox"
              checked={serviceDisruptions}
        ...
        <div className="settings-item">
          <span><HiMiniBellAlert /> Peak Hour Alerts</span>
          <label className="switch">
            <input
              type="checkbox"
              checked={peakHourAlerts}
      ...
      <section className="settings-section">
        ...
        <div className="settings-item">
          <span><MdDelete /> Delete Account </span>
          <span className="arrow">›</span>
        </div>
      </section>
      <footer className="footer-nav">
