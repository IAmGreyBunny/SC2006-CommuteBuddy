...
const CrowdDensity = () => {
    ...
    const fetchFavorites = useCallback(async () => {
        try {
            ...
            setFavorites(res.data.mrt_favourites || []);
        } catch (error) {
    ...
    const toggleFavorite = async (stationCode, stationName) => {
        ...
        try {
            if (fav) {
                ...
                alert(`Removed ${stationName} from favorites!`);
            } else {
                ...
                alert(`Added ${stationName} to favorites!`);
            }
            fetchFavorites();
        } catch (error) {
            ...
            <div className="drawer" style={{ height: `${drawerHeight}vh` }}>
                ...
                <div className="content" style={{ padding: '0 16px', overflowY: 'auto' }}>
                    ...
                    {loadingStations || loadingCrowd ? (
                        ...
                        <div className="station-details" key={favorites.length}> 
                            <header style={{ 
